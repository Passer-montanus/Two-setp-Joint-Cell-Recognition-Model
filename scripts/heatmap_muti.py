...
if __name__ == '__main__':
    ...
    # 分离模型参数和处理参数
    process_args = config.pop('process_args')  # 移除非类参数
    model = yolov8_heatmap(**config) # 正常半角星号
    ...
    for img_path in image_paths:
        ...
        save_path = os.path.join('Heatmap/muti/all/14', img_name)
