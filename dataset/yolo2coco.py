...
parser.add_argument('--image_path', default='D:/yolov8/dataset_mixup/images/test',type=str, help="path of images")
parser.add_argument('--label_path', default='D:/yolov8/dataset_mixup/labels/test',type=str, help="path of labels .txt")
parser.add_argument('--save_path', type=str,default='D:/yolov8/data.json', help="if not split the dataset, give a path to a json file")
