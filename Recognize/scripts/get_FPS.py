...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='D:/AI腹水/11.22/训练结果/107_2/runs/train/mixup2_yolov8-SPPF-LSKA_100_32/weights/best.pt', help='trained weights path')
    # parser.add_argument('--weights', type=str, default='D:/AI腹水/11.22/训练结果/216_1/runs/train/mixup2_yolov8-RCSOSA_100_32/weights/best.pt', help='trained weights path')
    # parser.add_argument('--weights', type=str, default='D:/AI腹水/11.22/训练结果/216_1/runs/train/mixup2_yolov8-C2f-ODConv_100_32/weights/best.pt', help='trained weights path')
    # parser.add_argument('--weights', type=str, default='yolov8n.pt', help='trained weights path') 
    # parser.add_argument('--weights', type=str, default='D:/AI腹水/11.22/训练结果/216_1/runs/train/mixup2_yolov8-C2f-OREPA_100_32/weights/best.pt', help='trained weights path')
